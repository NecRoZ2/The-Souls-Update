...
execute unless block ^-1 ^1 ^2 air run return fail
execute unless block ^-2 ^1 ^2 redstone_wire[east=none,north=none,south=none,west=none] run return fail
...
execute unless block ^ ^1 ^ redstone_wire run return fail
execute unless block ^-1 ^1 ^ redstone_wire run return fail
...
execute unless block ^-2 ^1 ^-2 air run return fail
execute positioned ^3 ^1 ^3 unless entity @e[distance=..1,type=item_frame,nbt={Item:{id:"minecraft:target"}}] run return fail
execute positioned ^-3 ^1 ^3 unless entity @e[distance=..1,type=item_frame,nbt={Item:{id:"minecraft:compass"}}] run return fail
execute positioned ^3 ^1 ^-3 unless entity @e[distance=..1,type=item_frame,nbt={Item:{id:"minecraft:ender_pearl"}}] run return fail
execute positioned ^-3 ^1 ^-3 unless entity @e[distance=..1,type=item_frame,nbt={Item:{id:"minecraft:chorus_fruit"}}] run return fail
return 1