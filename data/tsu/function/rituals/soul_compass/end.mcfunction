...
execute positioned ^-1 ^1 ^4 as @e[type=item_frame,distance=..1] at @s run function tsu:rituals/soul_compass/edit_book
...
execute positioned ^-3 ^1 ^3 as @e[type=item_frame,distance=..1] at @s run function tsu:rituals/rituals_function/use_catalyst
execute positioned ^-3 ^1 ^-3 as @e[type=item_frame,distance=..1] at @s run function tsu:rituals/rituals_function/use_catalyst
function tsu:rituals/soul_compass/select_result
