...
execute as @e[tag=Ritual_circle] unless score @s tsu.ritual_stage matches 1.. run scoreboard players set @s tsu.ritual_stage 1
schedule function tsu:altar/create_ritual_circle/stage1/end_stage1 10t