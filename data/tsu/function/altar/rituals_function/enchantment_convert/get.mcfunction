...
execute store result score ench_count tsu.globaldata store result score ench_count tsu.enchantments run data get storage enchantments raw_data
...
scoreboard players set #symbol_position tsu.enchantments 1
...
# Конец
scoreboard players reset * tsu.enchantments
