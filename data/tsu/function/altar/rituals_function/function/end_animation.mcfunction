...
$execute if function tsu:altar/rituals_function/function/$(ritual_type)/condition_check if function tsu:altar/rituals_function/function/$(ritual_type)/name_check run return run function tsu:altar/rituals_function/function/$(ritual_type)/end with entity @s data
