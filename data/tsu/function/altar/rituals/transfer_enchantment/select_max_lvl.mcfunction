...
scoreboard players operation lvl tsu.enchantments = I1_lvl tsu.enchantments
execute store result storage enchantments lvl int 1 run scoreboard players operation lvl tsu.enchantments > I2_lvl tsu.enchantments
