...
execute positioned ^ ^1 ^3 as @e[type=item_frame,distance=..1] at @s run function tsu:altar/rituals_function/function/use_catalyst
...
execute positioned ^-3 ^1 ^3 as @e[type=item_frame,distance=..1] at @s run function tsu:altar/rituals_function/function/use_catalyst
execute positioned ^-3 ^1 ^-3 as @e[type=item_frame,distance=..1] at @s run function tsu:altar/rituals_function/function/use_catalyst
function tsu:altar/rituals/souls_absorption/select_result
