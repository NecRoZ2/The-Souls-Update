...
execute as @a[scores={bell_ring=1..}] at @s run function tsu:altar/rituals_function/function/start_select_ritual
execute as @e[tag=Ritual_circle,scores={ritual_stage=3}] at @s run function tsu:altar/action/ritual_circle
